" Vim color file
" Converted from Textmate theme Text Ex Machina (Lighter comments) using Coloration v0.2.5 (http://github.com/sickill/coloration)
...
let g:colors_name = "Text Ex Machina (Lighter comments)"
...
hi Folded  guifg=#676767 guibg=#151515 gui=NONE
...
hi Todo  guifg=#676767 guibg=NONE gui=inverse,bold
